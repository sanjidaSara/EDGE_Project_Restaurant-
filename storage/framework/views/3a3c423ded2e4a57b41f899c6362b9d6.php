            ...
            <div class="row g-0">
                ...
                <div class="col-md-6 bg-dark d-flex align-items-center">
                    <div class="p-5 wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <form action="addbookingdata" method="POST">
                        <?php echo csrf_field(); ?>
                            <div class="row g-3">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        ...
                                        <input type="text" class="form-control" id="select1" name="select1" placeholder="No of people">
...
</html><?php /**PATH C:\xampp\htdocs\edge_again\project03\resources\views/booking.blade.php ENDPATH**/ ?>